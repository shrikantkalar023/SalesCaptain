...
export default function Home() {
  return (
    <main>
      <Navbar />
      <h1 className="mx-4 mb-8 mt-32 text-center text-4xl font-extrabold leading-tight sm:mt-40 sm:font-black md:text-5xl">
        Best way to grow your local business
      </h1>
      <p className="mb-12 px-4 text-center text-sm font-light leading-6 tracking-wide sm:text-base md:text-lg">
      ...
      <form className="mb-16 px-8 sm:mb-12 sm:flex sm:justify-center sm:gap-4">
        <input
          type="email"
          id="email"
          className="mb-6 block w-full rounded-lg border border-slate-300 p-2.5 text-center text-sm text-gray-900 placeholder-slate-400 focus:border-sky-500 focus:outline-none focus:ring-0 focus:ring-sky-500 sm:mb-0 sm:max-w-2xl sm:basis-3/5 sm:px-3.5 sm:text-left md:text-base"
        ...
        <div className="flex justify-center">
          <button
            type="submit"
            className="whitespace-nowrap rounded-lg bg-blue-600 px-7 py-3 text-center text-sm font-bold text-white hover:bg-blue-700 md:text-base"
          >
            GET DEMO
          </button>
        </div>
      ...
      <LogoWithBg />
      <Testimonials />
      <h1 className="mx-4 mb-11 mt-20 text-center text-3xl font-extrabold leading-tight sm:mb-12 md:text-5xl">
      ...
      <Services />
      <h2 className="mb-4 px-4 text-center text-3xl font-extrabold leading-tight sm:text-4xl md:text-5xl">
        Expert Insights and Resources
      </h2>
      <h3 className="mb-24 px-5 text-center text-sm font-light leading-snug sm:mb-28 sm:text-lg sm:font-normal md:text-xl">
      ...
      <div className="bg-stone-950/90 px-5 py-9 sm:bg-stone-950/95">
        ...
        <div className="mb-6 flex items-center justify-center gap-3">
          <img className="h-6 md:h-8" src="/stars.webp" alt="" />
          <p className=" text-sm font-extralight text-white md:text-base md:font-light">
            500+ Reviews
          </p>
        </div>
        <div className="flex items-center justify-center gap-2 sm:gap-4 md:gap-6">
          <img className="h-4 sm:h-6 md:h-8" src="/google.webp" alt="" />
          <img className="h-5 sm:h-7 md:h-9" src="/capterra.webp" alt="" />
          <img className="h-4 sm:h-6 md:h-8" src="/sofadv.webp" alt="" />
        </div>
      </div>
      <footer className="mb-4 bg-black px-5 py-8">
        ...
        <div className="sm:grid sm:grid-cols-3 sm:gap-20">
          ...
          <div className="mb-20 flex flex-col gap-6">
            <div>
              <h1 className="mb-2 text-sm font-semibold text-gray-400 md:text-base">
                US Headquarters
              </h1>
              <a href="#">
                <p className="pr-40 text-left text-xs font-light text-white underline-offset-2 hover:underline sm:pr-0 md:text-sm">
          ...
          <div className="mb-12 hidden flex-col gap-2 sm:flex sm:gap-0.5 md:gap-1">
            <h1 className="mb-2 text-sm font-semibold text-gray-400 md:text-base">
              Company
            </h1>
            <a
            ...
            <h1 className="mb-2 mt-6 text-sm font-semibold text-gray-400 md:text-base">
              Partner
            </h1>
            <a
              className=" text-sm font-light text-white decoration-white underline-offset-2 hover:underline"
        ...
        <div className="flex justify-center gap-2 sm:justify-end md:gap-3.5">
          <a href="#">
      ...
      <p className="mb-2 text-center text-xs font-extralight md:font-normal">
        © SalesCaptain Inc 2023 (A division of SalesBook Technologies Pvt Ltd)
      </p>
      <div className="mb-3 flex justify-between px-5 text-xs font-extralight md:font-normal">
